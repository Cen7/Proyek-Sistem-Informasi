...
app.get("/admin-list_lapak", (req, res) => {
  res.render("admin-list_lapak");
});

app.get("/admin-lapak_terblokir", (req, res) => {
  res.render("admin-lapak_terblokir");
});

app.get("/admin-bantuan", (req, res) => {
